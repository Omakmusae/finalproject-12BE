...
| iterator 적용 | For문을 사용하여 불필요한 순회 발생, 건너뛰기 기능이 없어 추가적인 코드 발생  | 리스트를 순회하며 객체를 삭제할 때 불필요한 순회를 방지하기 위해 Iterator의 remove 사용,
건너뛰기 기능을 사용하기 위해 Iterator의 hasNext(), next() 사용 |
